...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById("glow-effects").value = settings.glowEffects;
  document.getElementById(
    "glow-effects-value"
  ).textContent = `${settings.glowEffects}%`;
  ...
  document.getElementById("save-btn").addEventListener("click", function () {
    const settingsToSave = {
      ...
      glowEffects: document.getElementById("glow-effects").value,
  ...
  document.getElementById("default-btn").addEventListener("click", function () {
    ...
    document.getElementById("glow-effects").value = defaults.glowEffects;
    document.getElementById(
      "glow-effects-value"
    ).textContent = `${defaults.glowEffects}%`;
